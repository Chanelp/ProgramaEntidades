    ...
    public class RepositorioTiposEntidades
    {
        ...
        public TiposEntidades EnlistarPorId(int id)
        {
            ...
            try
            {
                ...
                {
                    entidad.IdTipoEntidad = dataReader.GetInt32(0);
                    entidad.Descripcion = dataReader.GetString(1);
                    entidad.IdGrupoEntidad = dataReader.GetInt32(2);
                    entidad.Comentario = dataReader.GetString(3);
                    entidad.Status = dataReader.GetString(4);
